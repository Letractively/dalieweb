...
public class CreateDataMessage {
	...
	public synchronized void insertMessage(Database dbConn,String messageId,String sprachId,String messageTyp,
	 ...
	 public static void main(String args[]) throws Exception{
    	...
    	dataMessage.insertMessage(dbConn,"DeleteDokumentTyp","DE","E","Dokumenttyp <b>löschen</b> nicht möglich, da noch Dokumente zum Dokumenttyp gefunden wurden.");
    	...
    	dataMessage.insertMessage(dbConn,"Title","EN","E","Title <b> error </ b>");
    	dataMessage.insertMessage(dbConn,"Description","EN","E","Description <b>error</ b>,please check.");
    	dataMessage.insertMessage(dbConn,"DeleteDokumentTyp","EN","E","<b>Delete</b> this document is not possible as yet documents have been found to document.");
    	...
    	dataMessage.insertMessage(dbConn,"street number","EN","E","<b> invalid </ b> number, please specify.");
    	...
    	dataMessage.insertMessage(dbConn,"place","EN","E","Please <b> valid </ b> Cityname you enter, this is needed to address.");
    	dataMessage.insertMessage(dbConn,"zip code","EN","E","<b> valid </ b> zip code, please specify.");
    	dataMessage.insertMessage(dbConn,"Street","EN","E","<b> valid <b> street, please specify.");
    	dataMessage.insertMessage(dbConn,"First name","EN","E","<b> First </ b>, please specify.");
    	dataMessage.insertMessage(dbConn,"contry","EN","E","Please enter a valid <b>country</ b>, is part of a valid address.");
    	dataMessage.insertMessage(dbConn,"Password","EN","E","Forgot your password entry with no repetition indet");
