...
<link href="<%= request.getContextPath()%>/theme/selinas-SiteTyp2.css" rel="stylesheet" type="text/css" media="screen"/>
	...
	<div id="header">
		...
		<div id="headerMenu">
				<ul>
					...
					<li><a class="on" href="selinas-SiteTyp2.jsp">SiteTyp 2</a></li>
