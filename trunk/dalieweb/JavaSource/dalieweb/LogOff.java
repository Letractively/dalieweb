...
public class LogOff extends HttpServlet implements Servlet {
    	...
    	protected void perForm(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	    ...
    	    session.invalidate();
    	    performForward("/lebenslauf/lebenslauf001.jsp", request, response);//go back to User-Login
    	}//perForm
    	...
    	public String getServletInfo() {
    	    return "User-Logout on Lebenslauf";
    	}//getServletInfo
