/*
* Created of DV0101 on 09.02.2010 10:16:52
*
* Filename	  CreateTableInserat.java
*/
...
*
* @version 	1.00 09.02.2010 um 10:16:52
* @author 		DV0101
* <br><br>
*/
public class CreateTableInserat {

	public synchronized void createTableInserat(Database dbConn){
		try {
			dbConn.executeUpdate(
				"CREATE TABLE "+dbConn.getDbSchema()+".inserat( " +
					"kundenId int NOT NULL COMMENT '0 KundenId'," +
					"standortId int NOT NULL COMMENT '1 StandortId'," +
					"typ char(3) NOT NULL COMMENT '2 TypKey des Inserats'," +
