...
<body class="yui-skin-sam" onload="if(document.images) nextimg(), resizeFrame()">
	...
	<div id="bd">
		...
		<!-- 3.Zeile gesamte Breite  -->
			<iframe style="margin-bottom: 3px;" src="<%= request.getContextPath()%>/forum/forum001F.jsp" id="selinasFrame" name="selinasFrame" height="540" width="945" frameborder="0"></iframe>
		</div><!-- /yui-gf 1.Zeile gesamte Breite -->
	</div><!-- /bd body -->
	</div><!-- /doc3 = 100%, -->
   	<div id="ft">
