...
<link href="<%= request.getContextPath()%>/theme/selinas-SiteTyp8.css" rel="stylesheet" type="text/css" media="screen"/>
		...
		<h1>Header</h1>
			<div id="headerMenu">
				<ul>
					...
					<li><a href="selinas-SiteTyp4.jsp">SiteTyp 5</a></li>
					<li><a href="selinas-SiteTyp6.jsp">SiteTyp 6</a></li>
					<li><a href="selinas-SiteTyp7.jsp">SiteTyp 7</a></li>
					<li><a class="on" href="selinas-SiteTyp8.jsp">SiteTyp 8</a></li>
