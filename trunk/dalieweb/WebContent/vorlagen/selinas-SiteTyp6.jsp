...
<link href="<%= request.getContextPath()%>/theme/selinas-SiteTyp6.css" rel="stylesheet" type="text/css" media="screen"/>
...
<div id="wrapper">
		...
		<h1>Header</h1>
			<div id="headerMenu">
				<ul>
					...
					<li><a class="on" href="selinas-SiteTyp6.jsp">SiteTyp 6</a></li>
	...
	<div id="contentRight">	
		<h2>Content Right</h2>
		<ul>
					<li><a class="on" href="selinas-SiteTyp1.jsp">SiteTyp 1</a></li>
					<li><a href="selinas-SiteTyp2.jsp">SiteTyp 2</a></li>
					<li><a href="selinas-SiteTyp3.jsp">SiteTyp 3</a></li>
					<li><a href="selinas-SiteTyp4.jsp">SiteTyp 4</a></li>
					<li><a href="selinas-SiteTyp5.jsp">SiteTyp 5</a></li>
