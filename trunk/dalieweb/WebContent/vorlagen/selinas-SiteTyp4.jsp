...
<link href="<%= request.getContextPath()%>/theme/selinas-SiteTyp4.css" rel="stylesheet" type="text/css" media="screen"/>
		...
		<h1>Header</h1>
			<div id="headerMenu">
				<ul>
					...
					<li><a class="on" href="selinas-SiteTyp4.jsp">SiteTyp 4</a></li>
