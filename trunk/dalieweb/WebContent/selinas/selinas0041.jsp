...
<link href="http://yui.yahooapis.com/2.7.0/build/reset-fonts-grids/reset-fonts-grids.css" rel="stylesheet" type="text/css" media="screen"/>
				...
				<tr>
					...
					<td width="15%" align="left"><em><%= show.session.getStatus() %> :</em></td><td width="35%" align="left" valign="middle">
							...
							<div id="panel1">
											...
											<div class="bd"><%=(String)session.getAttribute("PermitInfo")%></div>
											<div class="ft">&nbsp;</div>
							</div>
				</td>
				</tr>
...
<div class="yui-gf">
    <div class="yui-u first">
		<table width="99%" border="0" cellpadding="0" cellspacing="3" class="details">
				<tr>
					<td align="left" valign="top">Anlagen</td>
				</tr>
		</table>
	    </div><!-- /yui-u first -->
    <div class="yui-u">
		<table width="99%" border="0" cellpadding="0" cellspacing="3" class="details">
			<tr>
				<td align="left"><dalie:selinas004FLTag data="N" columnHeader='<%= new Selinas004H().valueOf("4",language,linkOrderByTyp) %>' tableTagClass="linkTable"></dalie:selinas004FLTag>
...
<div class="yui-gf">
    <div class="yui-u first">
		<table width="99%" border="0" cellpadding="0" cellspacing="3" class="details">
			<tr>
				<td align="left"><%= show.session.getCaption9() %></td>
			</tr>
		</table>	
	</div><!-- /yui-u first -->
    <div class="yui-u">
			<table width="99%" border="0" cellpadding="0" cellspacing="3" class="details">
							...
							<tr>
								<td align="left"><dalie:HinweisOption message='${requestScope.upload}'></dalie:HinweisOption><!-- CLASS:HinweisOption --></td>
							</tr>
			</table>
	    </div><!-- /yui-u -->
</div><!-- /yui-gf  -->			
...
<div class="yui-gf">
    <div class="yui-u first">
			<table width="99%" border="0" cellpadding="0" cellspacing="3" class="details">
			<tr>
				<td align="left"><%= show.session.getCaption10() %></td>
			</tr>
		</table>	
	    </div><!-- /yui-u first -->
    <div class="yui-u">
